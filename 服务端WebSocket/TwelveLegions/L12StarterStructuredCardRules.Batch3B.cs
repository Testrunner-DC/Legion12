...
public static partial class L12StructuredCardRules
{
    ...
    internal static IReadOnlyList<L12AbilityView> StarterRemainingAbilityViews(string cardId) => cardId switch
    {
        ...
        "ST02-M1" => [new("horusRevive", "我方 回合1次 可弃置我方战场2张<陵墓守卫> 或 消耗1士气并弃置我方战场2张军团：选择墓地1张兵力不高于2000的【太阳城】军团休整登场。")],
        ...
        out IReadOnlyList<L12StructuredAbilityTemplate> abilities)
    {
        abilities = cardId switch
        {
            ...
            "ST02-M1" => [Targeted("active", "我方 回合1次 可弃置我方战场2张<陵墓守卫> 或 消耗1士气并弃置我方战场2张军团：选择墓地1张兵力不高于2000的【太阳城】军团休整登场。",
                new(L12AtomKinds.SelectMode, "选择费用支付方式", "cost", new() { ["options"] = "discard-tomb-guards|morale-and-discard-legions" }),
                new(L12AtomKinds.Discard, "弃置我方战场2张〈陵墓守卫〉", "cost", new() { ["amount"] = "2", ["mode"] = "discard-tomb-guards" }),
