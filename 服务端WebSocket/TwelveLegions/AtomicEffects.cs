...
public static class L12VerifiedAtomicPrograms
{
    ...
    private static Dictionary<string, L12VerifiedAtomicProgram> Build()
    {
        var programs = new[]
        {
            ...
            StarterTargetedProgram("ST01-07", "after-attack", "crossbow-ready"),
            StarterTargetedProgram("ST01-09", "enter", "wangzhaojun-draw"),
            StarterTargetedProgram("ST01-10", "reaction", "hidden-pass-summon"),
            StarterTargetedProgram("ST03-07", "enter", "kane-enter-mill"),
            ...
            StarterTargetedProgram("ST06-04", "death", "mordred-death-kill"),
            StarterTargetedProgram("ST06-07", "enter", "boudica-immortal"),
            Program("ST01-06", "enter",
                Atom(L12AtomKinds.SetState, "本回合下一张军团登场费用-1",
                    ("key", "controller.next-legion-entry-discount"), ("operation", "increment"), ("value", "1"),
                    ("event", "{source}使本回合下一张军团登场费用-1"))),
            Program("ST01-08", "enter",
                Atom(L12AtomKinds.SetState, "本回合对方军团挑衅效果无效",
                    ("key", "opponent.taunt-disabled-this-turn"), ("value", "current-turn"),
                    ("event", "聂隐娘使本回合对方军团的挑衅效果无效"))),
            Program("ST03-02", "continuous",
                Atom(L12AtomKinds.Condition, "此军团位于手牌且我方主宰血量不高于7",
                    ("expression", "source.zone=hand;controller.hp<=7")),
                Atom(L12AtomKinds.SetState, "登场费用-1",
                    ("key", "source.derived-cost"), ("operation", "add"), ("value", "-1"))),
            Program("ST03-04", "after-damage",
                Atom(L12AtomKinds.Draw, "抽取2张牌", ("amount", "2"),
                    ("emptyLossReason", "维京掠夺者效果抽牌时牌库为空"),
                    ("event", "维京掠夺者对主宰造成伤害后抽取2张牌"))),
            Program("ST02-08", "enter",
                Atom(L12AtomKinds.Draw, "我方抽取1张牌", ("amount", "1"), ("target", "controller"),
                    ("emptyLossReason", "阿肯那顿效果抽牌时牌库为空"), ("event", "阿肯那顿使我方抽取1张牌")),
                Atom(L12AtomKinds.Draw, "随后对方抽取1张牌", ("amount", "1"), ("target", "opponent"),
                    ("emptyLossReason", "阿肯那顿效果使对方抽牌时牌库为空"), ("event", "阿肯那顿使对方抽取1张牌"))),
            StarterTargetedProgram("ST02-08", "death", "akhenaten-death-heal"),
            Program("ST05-04", "enter",
                Atom(L12AtomKinds.Condition, "我方战场军团合计兵力少于对方", ("expression", "controller.field-troops<opponent.field-troops")),
                Atom(L12AtomKinds.Optional, "可抽取2张牌", ("prompt", "美狄亚：是否抽取2张牌？"), ("yes", "抽取2张牌"), ("no", "不发动")),
                Atom(L12AtomKinds.Draw, "抽取2张牌", ("amount", "2"), ("emptyLossReason", "美狄亚效果抽牌时牌库为空"), ("event", "美狄亚抽取2张牌"))),
            Program("ST05-09", "attack",
                Atom(L12AtomKinds.Keyword, "获得震击", ("keyword", "shock"), ("event", "美杜莎本次进攻获得震击")),
                Atom(L12AtomKinds.ModifyTroops, "本回合兵力+1000", ("operation", "add"), ("value", "1000"), ("duration", "this-turn"), ("event", "美杜莎本回合兵力+1000"))),
            StarterTargetedProgram("ST06-09", "enter", "light-sword-enter-kill"),
            ...
            StarterTargetedProgram("ST01-M1", "morale-return", "change-rested-morale"),
            StarterTargetedProgram("ST02-07", "opponent-back-to-front", "tomb-defender-debuff"),
            StarterTargetedProgram("ST02-10", "play", "starter-tomb-guard-revive"),
            StarterTargetedProgram("ST02-M1", "active", "horus-revive"),
            ...
            StarterTargetedProgram("ST04-10", "continuous", "invasion-fire-discount"),
            StarterTargetedProgram("ST04-10", "play", "invasion-fire"),
            StarterTargetedProgram("ST04-M1", "legion-attack-timing", "kagutsuchi-buff"),
            StarterTargetedProgram("ST05-01", "promotion-enter", "aeneas-promotion-search"),
            ...
            StarterTargetedProgram("ST06-S1", "active", "sky-city-discount"),
