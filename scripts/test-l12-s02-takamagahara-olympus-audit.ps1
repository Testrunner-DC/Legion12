...
Assert-Contains $tests 'Assert.Equal(105, AuditedAbilityCounts.Values.Sum())' 'The current S02 Takamagahara and Olympus ability inventory must remain frozen at 105.'
...
Write-Host 'S02 Takamagahara + Olympus per-ability audit guard passed (35 cards / 105 abilities).'
