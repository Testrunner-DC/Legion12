...
const checks = [
  ...
  [admin.includes("hasPermission('admin.accounts.roles.write')") && admin.includes("hasPermission('admin.sessions.revoke')") && admin.includes("hasPermission('admin.accounts.status.write')"), '账号角色、会话与状态动作必须按精确权限裁剪'],
