...
async function geometry(name) {
  const report = await page.evaluate(() => {
    ...
    return {
      safe, box, outside: outside(box), overflow: root.scrollWidth > innerWidth + 1 || root.scrollHeight > innerHeight + 1,
      ...
      utility: dock.querySelectorAll('.battle-utility-dock button').length,
