...
const contracts = [
  ...
  [windowsVerify.includes('ops\\performance-budgets.json') && windowsVerify.includes('ops\\performance-exceptions.json'), '提交级隔离前端构建必须复制性能预算与例外清单，性能架构门禁不得依赖开发工作树中的根级配置'],
