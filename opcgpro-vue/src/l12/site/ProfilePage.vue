...
@media(max-width:700px){
  ...
  .feedback-banner{display:none}.performance-panel{padding:12px}.performance-panel>header{align-items:flex-start}.side-stats{grid-template-columns:repeat(2,minmax(0,1fr))}
