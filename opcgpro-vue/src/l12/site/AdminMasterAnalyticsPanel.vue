...
<template>
  <section class="master-analytics">
    ...
    <template v-if="selected">
      ...
      <section class="panel"><header><h3>主宰对阵矩阵</h3><p>每格为行主宰对列主宰的胜率；少于30份显示“—”。</p></header><MasterMatchupMatrix :masters="matrixRows" :cells="matrixCells" :minimum-sample="30"/></section>
