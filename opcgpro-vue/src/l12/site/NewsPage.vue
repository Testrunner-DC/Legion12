...
<style scoped>
.news-page{min-height:100%;padding:0 clamp(18px,4vw,64px) 56px;font-family:'Microsoft YaHei','微软雅黑',sans-serif}.news-page>header{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;padding:34px 0 22px}.news-page>header small{color:#52c4cb;font:900 14px monospace;letter-spacing:.2em}.news-page h1{margin:6px 0;font-size:32px}.news-page>header p{margin:0;color:#7c898f;font-size:14px}.news-page>header input{width:min(320px,38vw);padding:11px;border:1px solid #35424a;background:#080e13;color:#fff}.category-tabs{display:flex;overflow-x:auto;border:1px solid #35424a;background:#0a1117}.category-tabs button{display:flex;align-items:center;justify-content:center;gap:7px;min-width:120px;padding:12px 16px;border:0;background:transparent;color:#7d898f;font-weight:900;white-space:nowrap}.category-tabs button.active{background:#243036;color:#f0d06f}.category-tabs span{display:grid;min-width:18px;height:18px;place-items:center;border-radius:9px;background:#18232a;color:#65cbd0;font-size:14px}.news-list{margin-top:14px;border:1px solid #35424a;background:#0f171f}.news-list article{display:grid;grid-template-columns:minmax(180px,300px) 1fr;min-height:230px;border-bottom:1px solid #35424a}.news-list article:last-child{border-bottom:0}.news-list article>img{width:100%;height:100%;max-height:320px;object-fit:cover}.news-copy{padding:26px}.news-list time{color:#d9b65f;font-size:14px;font-weight:900}.news-list h2{margin:8px 0;font-size:23px}.news-list p{color:#8c979c;font-size:14px;line-height:1.8;white-space:pre-wrap}.summary{display:-webkit-box;overflow:hidden;-webkit-box-orient:vertical;-webkit-line-clamp:3}.news-list details{margin-top:16px;color:#c9d0cd}.news-list summary{cursor:pointer;color:#56c4cb;font-size:14px;font-weight:900}.news-body{padding:12px;border-left:2px solid #4daeb5;background:#0a1116;color:#bcc4c1!important}.news-copy footer{display:flex;justify-content:space-between;margin-top:20px;color:#56c4cb;font-size:14px;font-weight:900}.news-copy footer a{color:#e1c36e;text-decoration:none}.pinned{box-shadow:inset 3px 0 #d6b85e}.empty{display:flex;min-height:320px;flex-direction:column;align-items:center;justify-content:center;color:#707d84;text-align:center}.empty b{color:#9aa3a7}.empty span{margin-top:6px;font-size:14px}@media(max-width:700px){.news-page{padding:0 12px 48px}.news-page>header{align-items:stretch;flex-direction:column}.news-page>header input{box-sizing:border-box;width:100%}.news-list article{grid-template-columns:1fr}.news-list article>img{max-height:210px}.news-copy{padding:20px}}
.content-page-actions{display:flex;align-items:center;gap:12px}.content-page-actions>a{padding:10px 14px;border:1px solid #d9bb69;color:#e3c779;font-size:14px;font-weight:900;text-decoration:none}@media(max-width:700px){.content-page-actions{align-items:stretch;flex-direction:column}.content-page-actions>a{text-align:center}}
.news-list:not(.video-grid):not(.product-list) article>img{align-self:start;width:100%;height:auto;max-width:100%;max-height:none;object-fit:contain;background:#080e13}.news-list.product-list article>img{aspect-ratio:4/3;object-fit:cover}.news-list.video-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(300px,100%),1fr));gap:22px;padding:22px;border:0;background:transparent}.video-card{display:flex!important;min-width:0;min-height:0!important;flex-direction:column;border:1px solid #35424a!important;background:#0f171f;color:#fff;text-decoration:none}.video-cover{position:relative;display:block;width:100%;aspect-ratio:16/9;overflow:hidden;background:#111c23}.video-cover img{width:100%;height:100%;object-fit:cover}.video-cover i{position:absolute;right:16px;bottom:14px;display:grid;width:42px;height:42px;place-items:center;border:1px solid #e0c26d;border-radius:50%;background:rgba(4,9,12,.75);color:#e0c26d;font-style:normal}.video-card-copy{display:flex;min-width:0;min-height:104px;flex-direction:column;gap:8px;padding:18px}.video-card-copy b{display:-webkit-box;overflow:hidden;overflow-wrap:anywhere;font-size:18px;line-height:1.45;-webkit-box-orient:vertical;-webkit-line-clamp:2}.video-card-copy em{overflow:hidden;color:#c4ccce;font-size:14px;font-style:normal;text-overflow:ellipsis;white-space:nowrap}@media(max-width:640px){.news-list.video-grid{grid-template-columns:1fr;padding:0}.video-card-copy{min-height:92px}}
.news-list .list-entry{display:grid;grid-template-columns:minmax(180px,300px) 1fr;min-height:230px;border-bottom:1px solid #35424a;color:inherit;text-decoration:none}.news-list .list-entry:last-of-type{border-bottom:0}.news-list:not(.product-list) .list-entry>img{align-self:start;width:100%;height:auto;max-width:100%;max-height:none;object-fit:contain;background:#080e13}.news-list.product-list .list-entry>img{aspect-ratio:4/3;object-fit:cover}.news-list a.list-entry:hover{background:#151f27}.news-copy footer>b{color:#e1c36e;font-size:14px}.detail-page-head{align-items:center!important}.back-to-list{padding:11px 16px;border:1px solid #d9bb69;color:#e3c779;font-size:14px;font-weight:900;text-decoration:none}.news-detail{width:min(1040px,100%);margin:8px auto 0;border:1px solid #35424a;background:#101820}.detail-cover{display:block;width:100%;height:auto;max-width:100%;max-height:none;object-fit:contain;background:#080e13}.news-detail>article{padding:clamp(28px,6vw,76px)}.news-detail>article>header{display:flex;justify-content:space-between;gap:20px;padding-bottom:18px;border-bottom:1px solid #35424a;color:#d9b65f;font-size:14px;font-weight:900}.detail-summary{margin:25px 0;padding:18px 20px;border-left:3px solid #58c7ce;background:#0b1218;color:#b9c2c4;font-size:15px;line-height:1.8}.detail-body{color:#d4d9d8}.news-detail>article>footer{margin-top:32px;padding-top:20px;border-top:1px solid #35424a;text-align:right}.news-detail>article>footer a{color:#e1c36e;font-weight:900;text-decoration:none}.missing-detail{display:grid;min-height:460px;place-items:center;align-content:center;gap:18px;border:1px solid #35424a;background:#101820}.missing-detail a{color:#e1c36e}@media(max-width:700px){.news-list .list-entry{grid-template-columns:1fr}.news-detail>article{padding:24px 18px}.news-detail>article>header{flex-direction:column}.detail-page-head{align-items:stretch!important}.back-to-list{text-align:center}}
@media(max-width:520px){.news-page{padding:0 12px 42px}.news-page>header{gap:10px;padding:20px 0 14px}.news-page>header small{font-size:11px}.news-page h1{margin:4px 0;font-size:26px}.news-page>header p,.content-page-actions>a{font-size:12px}.news-page>header input{padding:10px;font-size:12px}.category-tabs button{min-width:98px;min-height:44px;padding:9px 11px;font-size:12px}.category-tabs span{min-width:16px;height:16px;font-size:10px}.news-list{margin-top:10px}.news-copy{padding:15px}.news-list time,.news-list p,.news-list summary,.news-copy footer,.empty span{font-size:12px}.news-list h2{margin:6px 0;font-size:19px}.news-list article,.news-list .list-entry{min-height:0}.detail-page-head{padding-bottom:12px!important}.back-to-list{padding:9px 12px;font-size:12px}.news-detail>article{padding:18px 14px}.detail-summary{margin:16px 0;padding:13px 14px;font-size:13px}.news-detail>article>header{font-size:12px}}
</style>
