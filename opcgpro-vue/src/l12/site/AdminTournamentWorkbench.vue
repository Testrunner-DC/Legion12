...
function createTournament() { void runAction('tournament:create', async () => {
  ...
  const tournament: TournamentCreateInput = {
    ...
    timeControl: tournamentTimeControlSeconds(timeControlMinutes),
