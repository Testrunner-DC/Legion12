...
<style scoped>
.recovery-page{display:grid;min-height:calc(100vh - 90px);place-items:center;padding:30px 16px;font-family:'Microsoft YaHei','微软雅黑',sans-serif}.recovery-card{box-sizing:border-box;width:min(520px,100%);padding:28px;border:1px solid #3a4850;background:#101821}.recovery-card>small{color:#58c7ce;font:900 14px monospace;letter-spacing:.18em}.recovery-card h1{margin:7px 0 12px}.recovery-card p{color:#879499;font-size:14px;line-height:1.7}.recovery-card label{display:block;margin:16px 0;color:#b8c0c1;font-size:14px;font-weight:900}.recovery-card input{box-sizing:border-box;width:100%;margin-top:7px;padding:11px;border:1px solid #4b5960;background:#080e13;color:#fff}.recovery-card button{display:block;width:100%;margin-top:16px;padding:11px;border:1px solid #dfbf68;background:#dfbf68;color:#080b0d;font-weight:900}.recovery-card button:disabled{opacity:.45}.recovery-card a{display:inline-block;margin-top:18px;color:#72cbd2;font-size:14px;text-decoration:none}.notice{padding:10px;border-left:3px solid #d1b25c;background:#241c0a;color:#edd584!important}
.feature-disabled{padding:12px;border-left:3px solid #8a6b32;background:#20190d;color:#d9c082!important}
@media(max-width:520px){.recovery-page{min-height:calc(100vh - 64px);padding:16px 10px}.recovery-card{padding:18px}.recovery-card>small{font-size:10px;letter-spacing:.14em}.recovery-card h1{margin:5px 0 8px;font-size:23px}.recovery-card p,.recovery-card label,.recovery-card a{font-size:12px}.recovery-card p{line-height:1.55}.recovery-card label{margin:12px 0}.recovery-card input{min-height:38px;margin-top:5px;padding:8px;font-size:12px}.recovery-card button{min-height:42px;margin-top:12px;padding:9px;font-size:13px}.recovery-card a{margin-top:13px}.notice,.feature-disabled{padding:8px}}
</style>
