...
<style scoped>
.block-editor{grid-column:1/-1;border:1px solid #46545d;background:#0b1218;color:#d6dcde}.block-editor-head{display:flex;align-items:center;justify-content:space-between;gap:18px;padding:18px 20px;border-bottom:1px solid #3a474e;background:#111b22}.block-editor-head>div{display:grid;gap:5px}.block-editor-head b{font-size:16px}.block-editor-head span{color:#98a4a9;font-size:14px;line-height:1.55}.block-editor nav,.insert-toolbar,.format-toolbar{display:flex;flex-wrap:wrap;align-items:center;gap:8px}.block-editor button,.block-editor select,.block-editor input,.block-editor textarea{border:1px solid #53616a;background:#070d12;color:#f3f5f4;font:inherit}.block-editor button{min-height:38px;padding:8px 12px;font-size:14px;font-weight:800}.block-editor button:hover:not(:disabled),.block-editor button.active{border-color:#d1b35e;color:#efd47f}.block-editor button:disabled{cursor:not-allowed;opacity:.38}.insert-toolbar{padding:14px 20px;border-bottom:1px solid #344149}.insert-toolbar>span,.format-toolbar>span{color:#9ca7ab;font-size:14px}.insert-toolbar .image-button{border-color:#3c8b91;color:#71d3d8}.block-list{display:grid;gap:16px;padding:20px}.editor-block{border:1px solid #3b4850;background:#0e171e}.editor-block.focused{border-color:#74858e;box-shadow:0 0 0 1px rgba(209,179,94,.35)}.editor-block>header{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:11px 13px;border-bottom:1px solid #303d44;background:#141e25}.editor-block>header select{min-width:180px;padding:8px 10px;font-size:14px}.editor-block>header>b{font-size:14px}.editor-block>header button{min-height:34px;padding:6px 10px;font-size:14px}.editor-block .delete{border-color:#74414a;color:#ef9aa4}.format-toolbar{padding:10px 13px 4px}.format-toolbar button{min-height:34px;padding:6px 10px}.format-feedback{margin:0;padding:0 13px 10px;color:#aeb8bb;font-size:14px;line-height:1.55}.editor-block>textarea{box-sizing:border-box;width:calc(100% - 26px);margin:0 13px 14px;padding:13px 14px;resize:vertical;font-size:14px;line-height:1.75}.link-panel{display:grid;gap:10px;margin:4px 13px 14px;padding:14px 16px;border:1px solid #957d3f;background:#17180f;box-shadow:0 12px 28px rgba(0,0,0,.28)}.link-panel>header{display:flex;align-items:center;justify-content:space-between;gap:12px}.link-panel>header strong{color:#efd47f;font-size:14px}.link-panel>header button{min-width:34px;min-height:32px;padding:4px 9px}.link-panel p{margin:0;color:#c2cbcd;font-size:14px;line-height:1.55}.link-panel q{color:#fff;word-break:break-word}.link-panel label{display:grid;gap:7px;color:#cbd2d4;font-size:14px;font-weight:800}.link-panel input{box-sizing:border-box;width:100%;min-height:42px;padding:9px 11px;font-size:14px}.link-panel small{color:#98a4a9;font-size:14px;line-height:1.55}.link-panel .link-error{color:#ff9ea8}.link-panel footer{display:flex;flex-wrap:wrap;gap:8px}.link-panel .apply{border-color:#b99b45;color:#efd47f}.selected-image-preview{display:grid;grid-template-columns:minmax(180px,320px) minmax(0,1fr);align-items:center;gap:16px;margin:16px;padding:14px;border:1px solid #3f5059;background:#091116}.selected-image-preview img{display:block;width:100%;max-height:220px;object-fit:contain;background:#04080b}.selected-image-preview figcaption{display:grid;gap:7px;min-width:0}.selected-image-preview figcaption b{color:#71d3d8;font-size:14px}.selected-image-preview figcaption span{overflow-wrap:anywhere;color:#bac4c7;font-size:14px;line-height:1.6}.empty-image-preview{margin:16px;padding:16px;border:1px dashed #4a5961;color:#aeb8bb;font-size:14px;line-height:1.6}.image-fields{display:grid;grid-template-columns:1fr 1fr;gap:14px;padding:16px}.image-fields label{display:grid;gap:7px;color:#bcc5c8;font-size:14px;font-weight:800}.image-fields label:first-child{grid-column:1/-1}.image-fields input,.image-fields select{box-sizing:border-box;width:100%;min-height:42px;padding:9px 11px;font-size:14px}.inline-upload{margin:0 16px 16px}.inline-upload summary{cursor:pointer;padding:12px;border:1px solid #3c8b91;color:#75d3d7;font-size:14px;font-weight:900}.inline-upload[open] summary{margin-bottom:12px}.editor-preview{margin:20px;padding:clamp(20px,4vw,48px);background:#f5f0df;color:#20282b}@media(max-width:780px){.block-editor-head{align-items:flex-start;flex-direction:column}.block-list{padding:12px}.editor-block>header{align-items:flex-start;flex-direction:column}.selected-image-preview{grid-template-columns:1fr}.image-fields{grid-template-columns:1fr}.image-fields label:first-child{grid-column:auto}}
</style>
