...
const props = defineProps<{ cards: DeckCard[]; modelValue: string[]; lockedId?: string }>()
...
<template>
  <div class="pool-picker">
    <header><input v-model="query" placeholder="按天灾名称或卡号筛选"/><span>已选 {{ modelValue.length }} 张</span></header>
    <div class="pool-grid">
