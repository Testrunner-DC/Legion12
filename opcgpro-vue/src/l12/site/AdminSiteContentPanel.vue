...
.site-content-head small{color:#55c6cd;font:900 14px monospace;letter-spacing:.18em}.site-content-head h2,.content-panel h3{margin:6px 0}.site-content-head p,.content-panel header p{margin:4px 0;color:#98a4a9;font-size:14px;line-height:1.6}
...
.site-content-nav{display:flex;overflow-x:auto;margin:16px 0;border:1px solid #35424a;background:#0a1117}.site-content-nav button{flex:1 0 135px;min-height:46px;padding:12px 15px;border:0;border-right:1px solid #2d3940;background:transparent;color:#a0aaae;font-size:14px;font-weight:900}.site-content-nav button.active{background:#2a2311;color:#efd170;box-shadow:inset 0 -3px #d3b256}
