...
}>(), { title: '筛选与排序', activeCount: 0, alwaysVisible: false })
...
<template>
  <button class="mobile-filter-trigger" :class="{ 'always-visible': alwaysVisible }" type="button" :aria-expanded="modelValue" @click="openFrom">
