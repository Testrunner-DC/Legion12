...
.hero-copy p{margin:12px 0 0;color:#d3d9d7;font-size:clamp(14px,1.1vw,16px)}
...
@media(max-width:700px){.hero-copy{right:18px;bottom:108px;left:18px;max-width:none;padding:14px 16px}.hero-copy h1{font-size:32px}.product-track picture,.product-track picture img,.product-track>a>img,.product-placeholder{aspect-ratio:4/3}}
...
.news-lines a b{grid-column:1/-1;font-size:14px}
.products-heading{display:flex;align-items:flex-end;justify-content:space-between;gap:28px;margin-bottom:36px}
.products-heading small{color:var(--gold);font:900 14px monospace;letter-spacing:.32em}
...
@media(max-width:700px){.hero-stage{min-height:0;aspect-ratio:1080/1440}.news-lines,.video-tiles,.product-track{grid-template-columns:1fr}.lead-video,.video-tiles>*{min-height:0;aspect-ratio:16/9}.products-heading{align-items:flex-start;flex-direction:column}.products-heading h2{font-size:40px}.featured-product{min-height:0;aspect-ratio:4/3}}
...
.carousel-controls{right:auto;bottom:28px;left:clamp(26px,5vw,78px);gap:12px;color:#fff}.carousel-controls strong{min-width:44px;font-size:21px;line-height:1}.carousel-controls>span{display:flex;gap:7px}.carousel-controls span button{width:46px;height:7px;background:rgba(255,255,255,.35)}.carousel-controls span button.active{background:#fff}.carousel-controls>.carousel-pause{width:26px;height:26px;border:1px solid rgba(255,255,255,.75);font-size:14px}
.hero-copy{top:17%;bottom:auto;transform:none}
@media(max-width:700px){.hero-notices{bottom:18px;width:min(520px,82vw)}.hero-notices a{padding:10px 16px}.carousel-controls{bottom:184px;left:18px}.carousel-controls span button{width:28px}.carousel-controls strong{font-size:17px}.hero-copy{top:12%;bottom:auto}}
.hero-copy{top:11%;box-sizing:border-box;width:min(560px,52%);max-width:none;padding:0;border:0;background:none;text-shadow:0 2px 5px rgba(0,0,0,.72)}.hero-copy>small{font-size:clamp(14px,1.25vw,18px);letter-spacing:.06em}.hero-copy h1{margin:5px 0 0;font-size:clamp(28px,3.2vw,52px);line-height:1.12}.hero-copy p{margin:13px 0 0;color:#fff;font-size:clamp(14px,1.3vw,19px);font-weight:700}.hero-copy strong{display:block;margin-top:22px;color:#fff;font-size:clamp(16px,1.8vw,28px);line-height:1.25}
.hero-notices{width:min(280px,34vw);max-height:34%;overflow-y:auto;overscroll-behavior:contain}.hero-notices a{flex:none}
@media(max-width:700px){.hero-copy{top:8%;right:18px;left:18px;width:auto}.hero-copy h1{font-size:30px}.hero-copy strong{margin-top:14px;font-size:17px}.hero-notices{width:min(320px,68vw);max-height:34%}}
...
@media(max-width:700px){.news-section::before{right:-1vw;top:-2vw;font-size:clamp(100px,19vw,310px)}}
...
@media(max-width:700px){.hero-copy{top:auto;right:18px;bottom:230px;left:18px;width:auto}}
.official-footer>.footer-brand{display:flex;align-items:center;gap:13px;color:#fff;font:900 14px monospace;letter-spacing:.16em}
...
.home-card-copy small{overflow:hidden;color:var(--gold);font-size:14px;text-overflow:ellipsis;white-space:nowrap}
...
.home-card-copy p{display:-webkit-box;overflow:hidden;margin:0;color:var(--muted);font-size:14px;line-height:1.6;-webkit-box-orient:vertical;-webkit-line-clamp:2}
...
@media(max-width:700px){.hero-notices{right:18px;left:auto}}
...
@media(max-width:520px){.hero-copy{right:14px;bottom:196px;left:14px}.hero-copy>small{font-size:11px}.hero-copy h1{font-size:26px;line-height:1.08}.hero-copy p{margin-top:8px;font-size:12px;line-height:1.55}.hero-copy strong{margin-top:10px;font-size:14px}.hero-notices{right:14px;bottom:14px;width:min(274px,78vw);gap:6px}.hero-notices a{min-height:34px;padding:7px 10px;font-size:12px;line-height:1.25}.carousel-controls{bottom:150px;left:14px;gap:8px}.carousel-controls strong{font-size:15px}.carousel-controls span button{width:22px;height:5px}.carousel-controls>.carousel-pause{width:24px;height:24px;font-size:12px}.news-section,.products-section,.community-video-section{padding:46px 14px}.section-heading{gap:8px;margin-bottom:20px}.section-heading small{font-size:11px}.section-heading h2,.products-heading h2{font-size:30px}.section-heading p{font-size:12px;line-height:1.65}.home-card-copy{gap:5px;padding:10px 0 12px}.home-card-copy small,.home-card-copy p{font-size:12px}.home-card-copy b{font-size:15px}.featured-editorial-main .home-card-copy b{font-size:19px}.official-footer{padding:32px 14px}.official-footer p,.official-footer>a{font-size:12px}}
</style>
