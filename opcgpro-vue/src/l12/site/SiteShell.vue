...
.site-brand img{border-color:rgba(255,255,255,.42);border-radius:4px;filter:brightness(0) invert(1)}
@media(max-width:760px){.mobile-brand img{width:30px;height:30px;border:1px solid rgba(255,255,255,.42);border-radius:3px;object-fit:cover;filter:brightness(0) invert(1)}.mobile-brand b{display:none}}
