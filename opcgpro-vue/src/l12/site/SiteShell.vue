...
const updateEntries = [
  {
    date: '2026-09-06', title: '最强称号规则、排位准备计时与对局体验更新', version: releaseVersion,
    sections: [
      { title: '称号与排行榜', items: [
