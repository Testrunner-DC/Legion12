  ...
  <div class="deck-builder-shell">
    ...
    <main v-else class="deck-builder-grid">
      ...
      <aside class="deck-list grand-panel">
        ...
        <section v-if="trialCapacity || automaticExtraCards.length" class="selected-extra-cards">
