...
.deck-card.landscape-thumbnail .card-image>.l12-card-image:not(.landscape-thumbnail-image){position:absolute;left:50%;top:50%;width:140%;height:71.43%;transform:translate(-50%,-50%) rotate(90deg);transform-origin:center}.builder-card-detail.horizontal{max-height:160px}.builder-card-detail.horizontal>.l12-card-image{width:116px;height:auto;aspect-ratio:8/5}
