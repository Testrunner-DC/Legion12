...
@media(max-width:820px){
  ...
  .deck-builder-grid{display:flex;flex-direction:column;overflow:visible;padding:8px}.deck-builder-grid .grand-panel{overflow:visible}.deck-side-column{display:contents}.deck-detail-panel{order:1;min-height:520px}.saved-decks-panel{order:4;max-height:360px}.deck-catalog{order:2;min-height:72vh}.deck-list{order:3;min-height:70vh}.deck-card-grid{grid-template-columns:repeat(3,minmax(92px,1fr));max-height:68vh}.deck-entries{max-height:46vh}.master-preview img{width:64px;height:64px}.catalog-filter-bar{grid-template-columns:repeat(2,minmax(0,1fr))}.catalog-filter-bar .filter-search{grid-column:1/-1}
}
