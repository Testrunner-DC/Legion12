...
<style scoped>
.picker-card{display:flex;min-width:0;flex-direction:column;gap:8px;padding:8px;border:1px solid #39464d;background:#111a21}.picker-card>b,.picker-card>small{white-space:normal;overflow-wrap:anywhere;font-size:max(14px,var(--l12-board-readable,14px))}.picker-image{display:block!important;width:100%;height:auto;aspect-ratio:5/7;padding:0!important;overflow:hidden}.picker-card.horizontal .picker-image{aspect-ratio:8/5}.picker-image .l12-card-image{height:100%;aspect-ratio:auto!important}.picker-card-actions{display:flex;gap:6px;margin-top:auto}.picker-card-actions button{flex:1;min-height:36px;justify-content:center;font-size:max(14px,var(--l12-board-readable,14px))}
.picker-mask{position:fixed;z-index:3200;inset:0;display:grid;padding:42px;background:#020507d9;place-items:center;font-family:'Microsoft YaHei','微软雅黑',sans-serif}.card-picker{display:grid;width:min(1180px,96vw);height:min(820px,90vh);grid-template-rows:auto auto minmax(0,1fr);border:1px solid #6a5a2a;background:#0b1116;color:#eff2ef;box-shadow:0 30px 100px #000}.card-picker>header{display:flex;align-items:center;justify-content:space-between;padding:15px 18px;border-bottom:1px solid #374147}.card-picker h2{margin:4px 0 0;font-size:max(20px,var(--l12-board-readable,14px))}.card-picker small{color:#cfad43;font:900 max(14px,var(--l12-board-readable,14px)) monospace;letter-spacing:.16em}.card-picker header button{border:0;background:transparent;color:#fff;font-size:max(24px,var(--l12-board-readable,14px))}.filters{display:grid;grid-template-columns:minmax(220px,2fr) repeat(5,minmax(92px,1fr));gap:7px;padding:12px;border-bottom:1px solid #303a40}.filters input,.filters select{min-width:0;padding:9px;border:1px solid #445159;background:#070c10;color:#fff;font-weight:800}.card-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(116px,1fr));gap:11px;overflow:auto;padding:14px;align-content:start}.card-grid button{display:grid;min-width:0;gap:4px;padding:6px;border:1px solid #39464d;background:#111a21;color:#fff;text-align:left}.card-grid button:hover{border-color:#e1bd50;box-shadow:0 0 14px #c598383d}.card-grid .l12-card-image,.card-grid button>span{width:100%;aspect-ratio:5/7;background:#050708}.card-grid button.horizontal .l12-card-image{aspect-ratio:8/5}.card-grid b{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:max(14px,var(--l12-board-readable,14px))}.card-grid small{overflow:hidden;color:#87949a;text-overflow:ellipsis;white-space:nowrap;font-size:max(14px,var(--l12-board-readable,14px))}.state{grid-column:1/-1;margin:auto;color:#829096}.state.error{color:#e28d94}@media(max-width:760px){.picker-mask{padding:8px}.card-picker{width:100%;height:96vh}.filters{grid-template-columns:1fr 1fr}.filters input{grid-column:1/-1}.card-grid{grid-template-columns:repeat(auto-fill,minmax(92px,1fr))}}
