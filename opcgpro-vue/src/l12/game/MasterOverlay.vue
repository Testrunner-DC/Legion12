...
<style scoped>
.master-related-card{display:grid;grid-template-columns:72px 1fr;gap:10px;margin-top:12px;padding:8px;border:1px solid #736731;background:#15150f}.master-related-card>.l12-card-image{width:72px;height:101px}.master-related-card strong{color:#e4c653;font-size:max(14px,var(--l12-board-readable,14px))}.master-related-card p{margin:5px 0 0;color:#ddd9c9;font-size:max(14px,var(--l12-board-readable,14px));line-height:1.6;white-space:pre-wrap}
...
.master-dialog{position:relative;display:grid;width:min(720px,calc(100vw - 36px));max-height:calc(100vh - 36px);grid-template-columns:220px 1fr;gap:22px;box-sizing:border-box;padding:22px;border:1px solid #ded9cc;background:linear-gradient(145deg,#171c1d,#07090a);box-shadow:0 24px 70px #000}.master-dialog>.l12-card-image{width:220px;height:308px;background:#050708}.master-content small{color:#70d7df;font-size:max(14px,var(--l12-board-readable,14px));letter-spacing:.15em}.master-content h2{margin:7px 0 4px;color:#fff;font-size:max(27px,var(--l12-board-readable,14px))}.master-content>b{color:#d2525b;font-size:max(14px,var(--l12-board-readable,14px))}.master-content>p{max-height:92px;overflow:auto;color:#d4d5cf;font-size:max(14px,var(--l12-board-readable,14px));font-weight:800;line-height:1.75;white-space:pre-wrap}.master-abilities{display:grid;gap:8px;margin-top:16px}.master-abilities button{padding:10px 12px;border:1px solid #70d7df;background:#132b2e;color:#fff;text-align:left}.master-abilities button:hover:not(:disabled){background:#1b6f77}.master-abilities button:disabled{border-color:#515755;background:#222625;color:#777}.master-abilities strong,.master-abilities span{display:block}.master-abilities strong{font-size:max(14px,var(--l12-board-readable,14px))}.master-abilities span{margin-top:3px;color:#c6cbc5;font-size:max(14px,var(--l12-board-readable,14px));line-height:1.45}.master-hint{display:block;margin-top:13px;color:#8d9490;font-size:max(14px,var(--l12-board-readable,14px))}.master-minimize,.master-close{position:absolute;top:9px;width:31px;height:29px;border:1px solid #777;background:#111;color:#fff;font-size:max(18px,var(--l12-board-readable,14px))}.master-minimize{right:47px}.master-close{right:9px}.master-overlay.minimized{z-index:2000;inset:auto 16px 66px auto;padding:0;background:transparent;backdrop-filter:none;pointer-events:none}.master-minimized{display:block;pointer-events:auto}.master-minimized button{padding:6px 10px;border:1px solid #70d7df;background:#174e54;color:#fff;box-shadow:0 12px 35px #000}
