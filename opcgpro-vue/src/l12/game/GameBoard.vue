...
.board-center{--l12-hand-lane-height:160px;--l12-clock-track-width:164px;display:grid;min-height:0;grid-template-columns:minmax(0,1fr) var(--l12-clock-track-width);grid-template-rows:var(--l12-hand-lane-height) minmax(0,1fr) var(--l12-hand-lane-height);align-items:stretch;column-gap:24px;row-gap:6px}
.board-center>.l12-hand,.board-center>.felt-board{grid-column:1}.board-center>.board-status-lane{grid-column:2;grid-row:2}
...
.board-center.timed-board>.l12-hand{width:calc(100% - 360px);transform:none}
...
.board-status-lane{position:relative;z-index:38;display:flex;box-sizing:border-box;width:100%;height:auto;min-height:0;justify-content:flex-end;justify-self:stretch;overflow:hidden;pointer-events:none}.board-player-clock{position:relative;right:auto;top:auto;bottom:auto;width:100%;max-width:var(--l12-clock-track-width);transform:none}.opponent-status-lane{align-self:start;align-items:flex-start}.my-status-lane{align-self:end;align-items:flex-end}.opponent-status-lane,.my-status-lane{order:0}
