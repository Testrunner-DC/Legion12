...
.card-choice{display:flex!important;align-items:center;gap:9px;padding:6px!important;text-align:left}.card-choice .l12-card-image{width:38px;height:52px;background:#050708}.card-choice span,.card-choice b,.card-choice small{display:block;min-width:0}.card-choice span{flex:1}.card-choice small{margin-top:3px;color:#849196;font-size:8px}.gm-hand{display:flex;gap:5px;overflow-x:auto;padding:5px 0 8px}.gm-hand button{flex:0 0 62px!important;width:62px!important;padding:3px!important;border-color:#354148!important;background:#080d11!important}.gm-hand button.active{border-color:#e2bc49!important;box-shadow:0 0 9px #c7963a66}.gm-hand .l12-card-image{display:block;width:54px;height:75px}.gm-hand span{display:block;overflow:hidden;margin-top:3px;color:#fff;font-size:7px;text-overflow:ellipsis;white-space:nowrap}.gm-hand p{margin:4px;color:#758187;font-size:9px}
</style>
