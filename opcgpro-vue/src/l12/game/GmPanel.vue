...
<style scoped>
.gm-panel,.gm-open{position:fixed;z-index:2100;right:12px;font-family:'Microsoft YaHei','微软雅黑',sans-serif}.gm-open{top:62px;width:46px;height:40px;border:1px solid #dfb746;background:#171208;color:#f2cf6d;font-weight:900}.gm-panel{top:60px;bottom:14px;width:320px;overflow-y:auto;border:1px solid #675825;background:#090d11f5;color:#edf0ed;box-shadow:0 22px 70px #000b}.gm-panel>header{position:sticky;z-index:2;top:0;display:flex;align-items:center;justify-content:space-between;padding:13px 14px;border-bottom:1px solid #665724;background:#0c1115}.gm-panel header small,.gm-panel header b{display:block}.gm-panel header small{color:#c9a945;font:900 var(--l12-board-copy,13px) monospace;letter-spacing:.17em}.gm-panel header b{margin-top:3px;font-size:var(--l12-board-copy,13px)}.gm-panel header button{border:0;background:transparent;color:#d9dedb;font-size:max(20px,var(--l12-board-copy,13px))}.security{margin:0;padding:9px 13px;background:#1f1909;color:#bda861;font-size:var(--l12-board-copy,13px);font-weight:800}.target-tabs{display:grid;grid-template-columns:1fr 1fr;padding:12px 12px 0}.target-tabs button{padding:9px;border:1px solid #3d4850;background:#111820;color:#89959a;font-weight:900}.target-tabs button.active{border-color:#d6ad3b;background:#d6ad3b;color:#111}.gm-panel section{padding:12px;border-bottom:1px solid #283139}.gm-panel h3{margin:0 0 9px;color:#d8c073;font-size:var(--l12-board-copy,13px)}.gm-panel input,.gm-panel select,.gm-panel section button{box-sizing:border-box;width:100%;min-height:34px;margin-top:6px;border:1px solid #44515a;background:#101820;color:#eef1ee;font-size:var(--l12-board-copy,13px);font-weight:800}.gm-panel input,.gm-panel select{padding:7px}.gm-panel button:disabled{cursor:not-allowed;opacity:.35}.gm-panel .primary{border-color:#d5ad3c;background:#d5ad3c;color:#111}.gm-panel .danger{border-color:#89313e;background:#3a1119;color:#f2b9c0}.compact,.two,.three,.number-row{display:grid;gap:6px}.compact,.two{grid-template-columns:1fr 1fr}.three{grid-template-columns:repeat(3,1fr)}.number-row{grid-template-columns:68px 1fr}.compact label{font-size:var(--l12-board-copy,13px)}.check{display:flex;align-items:center;gap:7px;margin-top:8px;color:#aab3b4;font-size:var(--l12-board-copy,13px)}.check input{width:14px;min-height:14px;margin:0}.gm-panel .wide{width:100%}.gm-panel footer{display:flex;align-items:center;justify-content:space-between;padding:12px}.gm-panel footer button{padding:8px 10px;border:1px solid #4e5b62;background:#111920;color:#fff;font-size:var(--l12-board-copy,13px);font-weight:900}.gm-panel footer span{color:#7c898e;font:800 var(--l12-board-copy,13px) monospace}@media(max-width:700px){.gm-panel{top:48px;right:5px;bottom:5px;width:min(320px,calc(100vw - 10px))}}
.hint{margin:7px 0 0;color:#859197;font-size:var(--l12-board-copy,13px);line-height:1.55}
.card-choice{display:flex!important;align-items:center;gap:9px;padding:6px!important;text-align:left}.card-choice .l12-card-image{width:38px;height:52px;background:#050708}.card-choice span,.card-choice b,.card-choice small{display:block;min-width:0}.card-choice span{flex:1}.card-choice small{margin-top:3px;color:#849196;font-size:var(--l12-board-copy,13px)}.gm-hand{display:flex;gap:5px;overflow-x:auto;padding:5px 0 8px}.gm-hand button{flex:0 0 62px!important;width:62px!important;padding:3px!important;border-color:#354148!important;background:#080d11!important}.gm-hand button.active{border-color:#e2bc49!important;box-shadow:0 0 9px #c7963a66}.gm-hand .l12-card-image{display:block;width:54px;height:75px}.gm-hand span{display:block;overflow:hidden;margin-top:3px;color:#fff;font-size:var(--l12-board-copy,13px);text-overflow:ellipsis;white-space:nowrap}.gm-hand p{margin:4px;color:#758187;font-size:var(--l12-board-copy,13px)}
</style>
