...
const props = defineProps<{ players: PlayerView[]; initialPlayer: number; actorPlayerIndex: number; canActivateOsiris?: boolean; inspectionOnly?: boolean; mobileLayout?: boolean }>()
...
function selectCard(card: Card) {
  ...
  if (player.value.playerIndex !== props.actorPlayerIndex) return
          ...
          <article>
            ...
            <div class="graveyard-cards">
              <div v-for="card in [...(player.graveyard || [])].reverse()" :key="card.instanceId" class="graveyard-card-entry">
                ...
                <button v-if="!inspectionOnly && player.playerIndex === actorPlayerIndex && canActivateOsiris && card.cardId === 'S01-02M2'"
