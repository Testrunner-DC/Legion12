...
@media(max-width:700px){.l12-action-presentation{top:10%;max-width:calc(100vw - 16px);padding:6px 9px}.action-copy strong{max-width:72vw;font-size:max(14px,var(--l12-board-readable,14px))}.action-symbol{width:37px;height:37px;flex-basis:37px;font-size:max(16px,var(--l12-board-readable,14px))}}
