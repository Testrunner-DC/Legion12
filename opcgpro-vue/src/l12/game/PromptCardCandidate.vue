...
.prompt-card-candidate .l12-card-image{width:96px;height:134px;margin:0 auto}.prompt-card-candidate__name{display:block;box-sizing:border-box;width:100%;min-height:34px;color:#fff;font-size:var(--l12-board-copy,13px);font-weight:900;line-height:17px;text-align:center;white-space:normal;overflow-wrap:anywhere}.prompt-card-candidate__meta{display:block;width:100%;overflow:hidden;color:#8edce2;font-size:var(--l12-board-copy,13px);font-weight:800;line-height:11px;text-align:center;text-overflow:ellipsis;white-space:nowrap}
...
.prompt-card-candidate__badge{position:absolute;left:7px;bottom:43px;padding:3px 6px;border:1px solid #f2d56d;background:rgba(20,14,2,.92);color:#ffe78d;font-size:var(--l12-board-copy,13px);line-height:1;box-shadow:0 2px 8px rgba(0,0,0,.65)}
