...
.prompt-card-candidate .l12-card-image{width:96px;height:134px;margin:0 auto}.prompt-card-candidate__name{display:block;width:100%;overflow:hidden;color:#fff;font-size:var(--l12-board-copy,13px);font-weight:900;line-height:17px;text-align:center;text-overflow:ellipsis;white-space:nowrap}.prompt-card-candidate__meta{display:block;width:100%;overflow:hidden;color:#8edce2;font-size:var(--l12-board-copy,13px);font-weight:800;line-height:11px;text-align:center;text-overflow:ellipsis;white-space:nowrap}
