...
.prompt-card-candidate__order{position:absolute;right:3px;top:3px;display:grid;min-width:20px;height:20px;padding:0 4px;place-items:center;border-radius:50%;background:#70d7df;color:#071012;font-size:max(14px,var(--l12-board-readable,14px))}
.prompt-card-candidate__badge{position:absolute;left:7px;bottom:43px;padding:3px 6px;border:1px solid #f2d56d;background:rgba(20,14,2,.92);color:#ffe78d;font-size:max(14px,var(--l12-board-readable,14px));line-height:1;box-shadow:0 2px 8px rgba(0,0,0,.65)}
.prompt-card-candidate__remove{position:absolute;right:2px;top:2px;padding:2px 4px;border:0;background:#8c2931;color:#fff;font-size:max(14px,var(--l12-board-readable,14px));font-style:normal}
</style>
