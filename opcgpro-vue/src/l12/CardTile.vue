...
.disabled-keyword{position:relative;border-color:#a6323a;background:rgba(38,12,15,.95);color:#c6b8b8}.disabled-keyword span{opacity:.72}.disabled-keyword i{position:absolute;inset:50% auto auto 50%;color:#ff4b58;font-size:max(22px,var(--l12-board-readable,14px));font-style:normal;font-weight:1000;line-height:1;text-shadow:0 0 5px #250005;transform:translate(-50%,-52%)}
.attached-card-orbs{position:absolute;z-index:9;right:3px;bottom:27px;display:flex;max-width:calc(100% - 6px);flex-direction:row-reverse;align-items:center;gap:1px;pointer-events:auto}.attached-card-orb{position:relative;display:grid;width:22px;height:22px;min-width:22px;place-items:center;padding:0;overflow:visible;border:1px solid #d8d2bd;border-radius:50%;background:#090b0c;box-shadow:0 2px 7px #000;cursor:pointer}.attached-card-orb img{position:static!important;inset:auto!important;width:100%!important;height:100%!important;border-radius:50%;background:#090b0c;object-fit:cover;object-position:center 14%;transform:scale(1.08)}.attached-card-orb i{color:#eee;font-size:max(14px,var(--l12-board-readable,14px));font-style:normal;font-weight:900}.attached-card-orb b{position:absolute;z-index:2;left:50%;top:-9px;display:grid;min-width:15px;height:15px;place-items:center;padding:0 3px;border:1px solid #f0e7c8;border-radius:8px;background:#111;color:#fff;font-size:max(14px,var(--l12-board-readable,14px));line-height:1;transform:translateX(-50%)}.attached-card-orb:hover,.attached-card-orb:focus-visible{border-color:#72d9df;box-shadow:0 0 9px rgba(112,217,223,.8);outline:none}
