...
<style scoped>
.card-tile{container-type:inline-size;--l12-card-edge:clamp(1px,2.4cqw,4px);--l12-card-stat-font:clamp(6px,11cqw,18px);--l12-card-stat-line:clamp(8px,16cqw,24px);--l12-card-stat-pad-x:clamp(1px,3cqw,5px);--l12-card-stat-pad-y:clamp(0px,1.2cqw,2px)}
