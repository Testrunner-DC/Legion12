...
export const BUILT_IN_RULINGS: RuleRuling[] = [
  ...
  { id: 'RULING-20260902-HELEN', scope: 'card', question: '海伦弃置手牌中的军团卡是否视为阵亡或离场？', answer: '裁定：该军团卡从手牌进入其所有者的墓地，属于弃置。此移动不视为战场上的阵亡或离场，因此不触发【阵亡时】或【离场时】。', category: '单卡裁定', sourceKind: 'user-ruling', sourceRef: '用户确认裁定 · 2026-09-02', recordedAt: '2026-09-02', status: 'published', cardIds: [], productIds: [], tags: ['海伦', '弃牌', '阵亡', '离场'], sourceIds: [], supersedes: [] },
  { id: 'RULING-20260902-PTOLEMY', scope: 'card', question: '托勒密十三世再次发动主动战术时，原费用与原战术实体如何处理？', answer: '裁定：只再次发动上一张主动战术的效果；不再次支付该战术原本的打出费用或冒号前费用，也不移动原战术实体。重复效果所需的公开信息仍须在其进入效果堆叠前声明。', category: '单卡裁定', sourceKind: 'user-ruling', sourceRef: '用户确认裁定 · 2026-09-02', recordedAt: '2026-09-02', status: 'published', cardIds: [], productIds: [], tags: ['托勒密十三世', '主动战术', '费用', '效果堆叠'], sourceIds: [], supersedes: [] },
