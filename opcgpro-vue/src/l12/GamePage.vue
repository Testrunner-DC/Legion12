...
<template>
  <div v-if="game" class="game-page">
    ...
    <div class="battle-route-controls">
      ...
      <button @click="returnToLobby">返回<span class="mobile-route-break" aria-hidden="true"></span>大厅</button>
...
.game-page:has(.mobile-landscape-board) :deep(.gm-panel){top:8px;right:8px;bottom:auto;box-sizing:border-box;width:min(320px,calc(100% - 16px));height:calc(100% - 16px)}
