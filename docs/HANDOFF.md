...
## 2026-09-17 天灾开场/主动触发来源分离（功能已提交，待提交级Release验证）
...
- 〈诸神黄昏〉现在任何回合阶段自然触发均为开场分支（双方各抽2）；只有军团/卡效主动触发才执行其余玩家抽2、结束当前回合与追加回合。功能提交`0a384b7`；天灾相关105/105、Focused规则3301/3301、Batch全池审计和Release配置规则3301/3301已通过，尚待提交级Release；未部署。
- 下一批：支援军团阵亡触发其【阵亡时】但不建立进攻军团【击杀时】事实，需扫描战斗时间线与恢复。
