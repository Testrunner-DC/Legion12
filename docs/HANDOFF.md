...
- **效果一致性最终收口**：独立工作树 `effect-consistency-p0-p6` 已重放到最新 `origin/main@cb835f6`，当前324张卡、686能力段、78生命周期档案、0未归属，自动矩阵78/78，P0—P6工程收口全部退出；尚未交Main、未推送、未部署。
...
- **固定交付顺序**：本工作树不自行推送/部署。现在交给Main推送、合入并部署一次测试服；Main核验版本和健康状态后开始后台卡效工作台；工作台完成后再部署一次测试服。工作台不得提前混入本批。
