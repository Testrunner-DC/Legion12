...
- 私密手牌反击战术→后排登场族已完成隔离Batch：完整扫描仅〈防御部署〉S02-0009与〈上杉谦信〉S01-0403；二者共用候选和逐对象结算复验，不补选失效手牌，合法同伴独立继续。防御部署正常/部分失效/零选择独立抽牌/实际无效/重复/V2恢复与上杉谦信正常/失效真实指令流，定向140/140；仅含本族13文件的隔离规则4070/4070、失败0、跳过0。待同批提交、干净Release及main精确读回，未部署。
