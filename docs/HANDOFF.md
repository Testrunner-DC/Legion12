...
- 当前进行中、未部署：手牌自伤减登场费用族精确命中传奇拉格纳、哈拉尔、埃里克、齐格鲁德、奥尔加、克努特6项。拒绝自伤按原费用继续；接受后支付1点伤害并仅降低本次费用。最后1血可支付但立即败北，卡留在手牌且后续不执行；本能力不独立入响应栈。专项47/47、台账生成器15/15、同族相邻172/172、完整Batch规则4286/4286通过，失败0、跳过0、退出0；共用归属87→93、待核对308→302。待同批提交与提交级Release。
