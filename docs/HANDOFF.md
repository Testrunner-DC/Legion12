...
- 结构化战斗限制消费者族已完成开发验证、待提交、未部署：侍从骑士真实进攻/V2恢复初始2红；不能进攻主宰、不能进攻、不能支援、汉尼拔不可被进攻及阿麦金保护现读取公共`AttackRule`，按钮目标、命令提交、支援、恢复和状态展示同源。专项12/12、含目录与相邻38/38、完整规则4143/4143通过；能力清单由生成器再生12/12。待干净Release和main同步。
