...
- 神力或弃牌在响应前支付；目标按当前军团类型、公开状态、有效【奥林匹斯】和费用3至6重验，失效=`failed`且不退款，被无效不赋予。强攻/震击为能力2下同一第1/1段的两个结果分支；取消、V2恢复和重复提交已覆盖。专项及声明绑定相邻21/21、Focused与Batch规则均3065/3065通过，提交级Release待跑；旧主动场景12→11，本批未部署。
