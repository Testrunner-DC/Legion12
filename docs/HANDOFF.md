...
- 试炼军团结构化身份族进行中、未部署：外部报告的S02八张经当前全池复查扩展为S02八张+ST06三张共11张；能力按钮、通常试炼行动、阿麦金与十字军东征候选/提交/结算/恢复已统一读取`cardType=legion && TrialValue>0`。东征响应后对象失效保留已付符文并明确失败。初始12红、相关44/44、相邻317/317、开发目录完整规则4131/4131通过；尚未完成提交级Release和main同步。
