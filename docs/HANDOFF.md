...
- **2026-09-27 特洛伊木马占位修复（Batch已通过）**：已确认玩家报告的“木马突然不见”共享根因：普通军团、新反击战术与效果生成军团只按反击类型判断可顶替，没有校验覆盖状态和所有者。三条路径已收敛到唯一“己方后排、己方所有、仍在覆盖”规则，合法顶替按真实所有者入墓。木马响应／置入／-1000／到期弃置抽牌主链不变。聚焦回归237/237、完整 Batch 规则5564/5564及全部相关审计通过；提交级 Release、推送待执行，本批不部署。
