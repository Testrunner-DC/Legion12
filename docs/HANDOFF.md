...
- 必中与攻击阻断响应族完成开发验证、待提交、未部署：全池命中佣兵部队、绝对防御、空城计3张，统一由`blocksAttack`驱动真实候选、匿名可用性、提交和V2恢复；战斗至黎明保留，绝对防御仍可无效独立进攻时效果。初始2红；专项3/3、相邻320/320、原子与目录89/89、完整规则4146/4146通过；待干净Release和main同步。
