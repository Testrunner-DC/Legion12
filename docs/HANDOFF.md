...
- 公开登场我方军团目标复验族正在收口、未部署：完整扫描Batch6JA命中墨子、拉美西斯、安卡神碑、卡诺匹斯罐一/四、安倍晴明、稻姬、井伊直虎。新增统一单/多目标出口，响应后重验当前场区、军团类型、有效阵营和各卡门槛；全失效失败、部分失效继续、不补位、已付Cost不退，稻姬不再把失败写成取消。初始9/9红；修复后专项9/9、相邻141/141、精确Focused与Batch静态门禁及完整规则4187/4187均通过、失败0、跳过0。下一步隔离Release、提交/main同步；不改响应窗口，未部署。
