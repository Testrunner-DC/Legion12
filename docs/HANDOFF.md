...
- 当前进行中、未部署：主动休整27个印刷能力段已绑定公共Cost档案，对应31个运行能力；只关闭运行身份、按钮、休整提交、支付回执和响应入栈的公共归属，不吞掉逐卡候选/其他费用/结算缺口。专项3/3、台账生成器14/14、主动休整全族相邻613/613、完整Batch规则4284/4284通过；共用归属60→87、待核对334→308，待统一提交与Release。
