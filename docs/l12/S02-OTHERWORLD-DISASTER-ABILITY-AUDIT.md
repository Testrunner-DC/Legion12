...
| S02-0606 帕西瓦尔 | 5 | 独立保留试炼1、贯穿定义；登场必发得符文走统一资源协议；进攻弃手牌预付获+2000；真实击杀后本回合获得贯穿。 | `L12SimpleResourceTriggerEffects`、`L12AttackPublicTriggerPlans`、`L12KillSourceEvents` | `SimpleResourceTriggerConsistencyTests`、`S02OtherworldHumanAssistedAtomicTests`、`AtomicReviewBatch6HRegressionTests`、`LatestBugRegressionTests` | 通过 |
