...
| S02-05M1 阿尔忒弥斯 | 4 | 远程阵亡翻士气使用`friendly-ranged-death`单段触发，与主动各自回合1次；主动费用/目标/分支保持独立，戒指通用军团合法。 | `L12SingleSegmentTriggeredEffectPresentations`、`L12PublicTriggerEffectPlans`、`L12S2RemainingEffects` | `AtomicReviewBatch6GARegressionTests`、`AtomicReviewBatch6LCRegressionTests` | 明确错误→已修复 |
